...
let html = `<div class='container-fluid d-flex justify-content-between border' > 
    <div class='d-flex'>
        ...
        <div style='width:100px'><p class="cart_title">${item.title}</p>
          <div id="post_addToCardDiv" >
            ...
            <i class='fa fa-remove cancelIcon'  id='${item.title}' onclick='removeFromCart(event)'></i>
            <h4 class="price_cart" style="font-size:22px;;position:relative;right:85px;top:10px;"><i class="fa">&#xf156;</i>${item['newPrice'] * item['count']}</h4>
</div>
        `
